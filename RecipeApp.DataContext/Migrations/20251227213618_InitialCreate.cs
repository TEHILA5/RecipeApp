        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientId2 = table.Column<int>(type: "int", nullable: false),
                    ConversionRatio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversions_Ingredients_IngredientId1",
                        column: x => x.IngredientId1,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conversions_Ingredients_IngredientId2",
                        column: x => x.IngredientId2,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversions_IngredientId1",
                table: "Conversions",
                column: "IngredientId1");

            migrationBuilder.CreateIndex(
                name: "IX_Conversions_IngredientId2",
                table: "Conversions",
                column: "IngredientId2");
